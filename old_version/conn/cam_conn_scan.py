...
def choose_fields_and_filter(input_file_path, output_file_path):
    # 要保留的字段名
    fields_to_keep = [ 'id.orig_h', 'id.orig_p','id.resp_h','id.resp_p','service','duration','orig_bytes','resp_bytes','missed_bytes','conn_state','history']
...
def main():
    # 设置输入和输出文件的路径
    input_file_path = 'conn.txt'
    intermediate_file_path = 'conn_scan_mid.txt'
    output_file_path = 'conn_scan.txt'
