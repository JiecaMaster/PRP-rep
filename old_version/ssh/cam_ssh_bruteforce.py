...
def choose_fields_and_filter(input_file_path, output_file_path):
    # 要保留的字段名
    fields_to_keep = [ 'id.orig_h', 'id.resp_h', 'auth_success']
...
def main():
    # 设置输入和输出文件的路径
    input_file_path = 'ssh.txt'
    intermediate_file_path = 'ssh_bruteforce_mid.txt'
    output_file_path = 'ssh_bruteforce.txt'
